...
## (abbreviated) state name
    ...
    data <- read.csv(file="C:/Users/Anirudh/Downloads/Video/computing for data analysis/hw/week 3/ProgAssignment3-data/outcome-of-care-measures.csv", colClasses = "character")
